"""
Django settings for dry_disk_43201 project.
...
ROOT_URLCONF = 'dry_disk_43201.urls'
...
WSGI_APPLICATION = 'dry_disk_43201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_disk_43201 API",
    "DESCRIPTION": "API documentation for dry_disk_43201 App",
    "VERSION": "v1",
}
